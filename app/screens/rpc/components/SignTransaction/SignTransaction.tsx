...
import { ApproveTransaction } from 'screens/rpc/components/SignTransaction/ApproveTransaction'
import { AddLiquidityTransaction } from 'screens/rpc/components/SignTransaction/AddLiquidity'
import { GenericTransaction } from 'screens/rpc/components/SignTransaction/GenericTransaction'
...
import { SwapTransaction } from 'screens/rpc/components/SignTransaction/SwapTransaction'
...
const SignTransaction = () => {
  ...
  const postApproveAndClose = useCallback(() => {
    dispatch(onRequestPostApproved(request))
    goBack()
  }, [dispatch, goBack, request])
  ...
  return (
    <RpcRequestBottomSheet
      onClose={requestResult ? postApproveAndClose : rejectAndClose}>
      <ScrollView contentContainerStyle={txStyles.scrollView}>
        <View>
          ...
          <Row
            ...
            <AvaText.Body2 color={theme.colorText1}>
              Approve {request.payload.peerMeta?.name} transaction
            </AvaText.Body2>
