export default {
  ...
  blackholeSwapButton: 'SWAP AVAX FOR USDC',
  core: 'https://core.app/',
  injectedCore:
    'https://core.app/portfolio/0xAa7C5180e46e8c995413B9FbDFEDE46f4B2B9Dc2/assets',
  aave: 'https://app.aave.com/',
  blackhole: 'https://blackhole.xyz/',
  blackholeSwap: 'https://blackhole.xyz/swap',
  // Browser UI controls
  tabsBtn: 'browser_tabs_btn',
