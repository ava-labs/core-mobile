...
export type RecoveryPhraseInputProps = {
  onChangeText: (text: string) => void
}

const RecoveryPhraseInput = forwardRef<TextInput, RecoveryPhraseInputProps>(
  function RecoveryPhraseInput({ onChangeText }, ref): JSX.Element {
