...
import { useWalletDisplayData } from 'features/accountSettings/hooks/useWalletDisplayData'
import React, { useCallback, useEffect, useMemo, useState } from 'react'
import { useSelector } from 'react-redux'
import { selectActiveAccount } from 'store/account'
import { selectActiveWalletId, selectWallets } from 'store/wallet/slice'

export const ManageAccountsScreen = (): React.JSX.Element => {
  const {
    theme: { colors }
  } = useTheme()
  ...
  const walletsDisplayData = useWalletDisplayData(searchText)
