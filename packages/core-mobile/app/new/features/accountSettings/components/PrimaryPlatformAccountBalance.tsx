...
import { useBalanceForPlatformAccount } from 'features/portfolio/hooks/useBalanceForPlatformAccount'

export const PrimaryPlatformAccountBalance = ({
  wallet,
  chainId
}: {
  wallet: Wallet
  ...
  const {
    ...
    isFetchingBalance,
    isBalanceLoaded
  } = useBalanceForPlatformAccount(wallet, chainId)
