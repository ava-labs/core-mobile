  ...
  const navigateToBuy = useCallback(
    (props?: NavigateToBuyParams) => {
      ...
      if (token || address) {
        ...
        // @ts-ignore TODO: make routes typesafe
<<<<<<<< HEAD:packages/core-mobile/app/new/features/meld/hooks/useBuy.ts
        navigate('/meld/onramp/selectBuyAmount')
========
        navigate('/meldOnramp/selectBuyAmount')
>>>>>>>> b13ee487b (rename folders):packages/core-mobile/app/new/features/meldOnramp/hooks/useBuy.ts
        return
      }
