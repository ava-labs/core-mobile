...
export const SendOnboarding = ({
  ...
  const handleNext = useCallback((): void => {
    hideIntro && dispatch(setViewOnce(ViewOnceKey.SEND_ONBOARDING))
    onNext()
  }, [hideIntro, dispatch, onNext])
  ...
  return (
    <SafeAreaView
      ...
      <View
        ...
        <Button type="primary" size="large" onPress={handleNext}>
          Let’s go!
        </Button>
      </View>
    </SafeAreaView>
