...
export type CalculateSolanaGasCostParams = {
...
/**
 * Calculate estimated gas cost for Solana swaps.
 ...
 */
export const calculateSolanaGasCost = ({
  fromToken,
  toToken,
  wrappedSolAtaExists,
  toTokenAtaExists
}: CalculateSolanaGasCostParams): bigint | undefined => {
