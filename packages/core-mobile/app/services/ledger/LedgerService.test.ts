...
describe('LedgerService', () => {
  ...
  describe('getAvalancheKeysForRange', () => {
    ...
    beforeEach(() => {
      ...
      jest.spyOn(LedgerService, 'openApp').mockResolvedValue(undefined)
      jest.spyOn(LedgerService, 'waitForApp').mockResolvedValue(undefined)
    })
    ...
    it('derives keys for each index from 0 to count-1', async () => {
      const spy = jest
        .spyOn(LedgerService, 'getAvalancheKeys')
  ...
  describe('getSolanaKeysForRange', () => {
    ...
    it('derives solana keys starting from a custom startIndex', async () => {
      ...
      expect(spy).toHaveBeenCalledWith(3, undefined, { skipAppCheck: true })
      expect(spy).toHaveBeenCalledWith(4, undefined, { skipAppCheck: true })
