...
import LedgerTrustedNameService, {
  SplTransferInfo
...
describe('LedgerTrustedNameService', () => {
  describe('extractSplTransferInfo', () => {
    it('returns null when txMessage has no instructions', () => {
      expect(LedgerTrustedNameService.extractSplTransferInfo({})).toBeNull()
      expect(LedgerTrustedNameService.extractSplTransferInfo(null)).toBeNull()
      expect(
        LedgerTrustedNameService.extractSplTransferInfo(undefined)
      ).toBeNull()
    })
    ...
    it('returns null when there is no TransferChecked instruction', () => {
      ...
      expect(
        LedgerTrustedNameService.extractSplTransferInfo(txMessage)
      ).toBeNull()
    })
    ...
    it('extracts info from a simple TransferChecked instruction', () => {
      ...
      const result = LedgerTrustedNameService.extractSplTransferInfo(txMessage)
  ...
  describe('enrollTrustedName', () => {
    ...
    const mockTransport = {
      ...
      typeof LedgerTrustedNameService.enrollTrustedName
    >[0]
    ...
    it('throws when CAL service returns non-ok', async () => {
      ...
      await expect(
        LedgerTrustedNameService.enrollTrustedName(
          mockTransport,
          mockSolanaApp,
          splInfo
        )
