...
describe('Testnet - Staking Tab', () => {
  ...
  it('Testnet - cross chain transfer C to P', async () => {
  ...
  it('Testnet - cross chain transfer C to X', async () => {
  ...
  it('Testnet - cross chain transfer P to C', async () => {
  ...
  it('Testnet - cross chain transfer P to X', async () => {
  ...
  it('Testnet - cross chain transfer X to C', async () => {
