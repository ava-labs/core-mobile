...
export function useBiometricLogin(w: MnemonicWallet, isDarkMode: boolean): [string, (() => Observable<boolean>), any] {
  ...
  useEffect(() => {
    switch (biometryType) {
      ...
      case BIOMETRY_TYPE.TOUCH_ID:
        setFingerprintIcon(isDarkMode ? require("../assets/icons/fingerprint_dark.png") : require("../assets/icons/fingerprint_light.png"))
        break
      case BIOMETRY_TYPE.FACE:
      case BIOMETRY_TYPE.FACE_ID:
        setFingerprintIcon(isDarkMode ? require("../assets/icons/face_id_dark.png") : require("../assets/icons/face_id_light.png"))
        break
